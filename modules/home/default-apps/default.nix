...
in
{
  options.ar.default-apps = {
    enable = mkEnableOption "Set default apps";
  };
  ...
  config = mkIf cfg.enable {
    ...
    home.activation.updateMimeCache = lib.home-manager.hm.dag.entryAfter [
      "writeBoundary"
    ...
    xdg.mimeApps = {
      enable = true;
      defaultApplications = mimeToAppMap {
